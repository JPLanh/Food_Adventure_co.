...
public class ImageButton extends JPanel implements UIComponent{
	/**
	 * 
	 */
	...
	public ImageButton(String getName, int getXPos, int getYPos, int getWidth, int getHeight, String getString, String getAction, Color getBKColor, Color getFontColor, int getSize)
	{
		name = getName;
		xPos = getXPos;
		yPos = getYPos;
	...
	public ImageButton(String getName, int getXPos, int getYPos, int getWidth, int getHeight, String getString, String getAction, Color getBKColor, Color getFontColor)
	{
		name = getName;
		xPos = getXPos;
		yPos = getYPos;
	...
	public ImageButton(String getName, int getXPos, int getYPos, int getWidth, int getHeight, String getString)
	{
		name = getName;
		xPos = getXPos;
		yPos = getYPos;
	...
	public ImageButton(Reward getReward, int getXPos, int getYPos, int getWidth, int getHeight, String getString, String getAction) {
		try {
...
//			img = new BufferedImage(getWidth, getHeight, BufferedImage.TYPE_INT_RGB);
	...
	public ImageButton(String getName, int getXPos, int getYPos, int getWidth, int getHeight, String getString, String getAction)
	{
		try {
			image = ImageIO.read(new File("img/avatar_dog.png"));
			img = resize(image, getHeight, getWidth);
//			img = new BufferedImage(getWidth, getHeight, BufferedImage.TYPE_INT_RGB);
		} catch (IOException e) {
			// TODO Auto-generated catch block
