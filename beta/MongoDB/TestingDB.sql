...
db.userTesting.insertOne({Name : "Phuong", Age : 110, Age : "iLuvPanda"});
db.userTesting.insertOne({Name : "Kelly", Age : 24, Age : "Hall_of_Fame"});
db.userTesting.insertOne({Name : "Jimmy", Age : 23, Age : "Lanh_Party"});
db.userTesting.insertOne({Name : "Aingty", Age : 23, Age : "NullPointer"});
db.userTesting.insertOne({Name : "Bruce", Age : 35, Age : "hashttag_noParent"});
db.userTesting.insertOne({Name : "Vader", Age : 44, Age : "DaddyIsHere"});
db.userTesting.insertOne({Name : "Frank", Age : 45, Age : "RebelScrum"});
db.userTesting.insertOne({Name : "Smeagel", Age : 130, Age : "ImPrescious"});
